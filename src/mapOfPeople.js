 ...
 *
 * You are given an array of numbers. Each of the numbers represents a i. A
 * number in the array may occur just once or it may occur several times, in
 * which case it denotes the same i every time it occurs.
 *
 ...
 * next number in the array is N, the i N enters the room if he wasn't
 * already in the room or leaves the room in case the i was already in the
 ...
 *
 * — i 1 entered the room at 0 seconds;
 * — i 3 entered the room at 1 second;
 * — i 2 entered the room at 2 seconds;
 * — i 1 left the room at 3 seconds;
 * — i 2 left the room at 4 seconds;
 * — i 1 reentered the room at 5 seconds.
 *
 ...
 * containing elements 3, 1 (in that order) with map[3] === 1 (as i 3
 * entered at 1 second) and map[1] === 5 (as the last time i 1 entered the
